...
def run_sofiia_questions(data):
    ...
    print("Актори з найбільшою кількістю фільмів:")
    ...
    print("Кількість фільмів жанрів по роках")
    genre_years.show(20)
    ...
    print("Регіони з найбільшою кількістю локалізацій")
    top_regions.show(20)
    ...
    print("Серіали з найвищим середнім рейтингом (і середньою к-стю голосів > 1000):")
    ...
    print("Топ-5 фільмів у кожному жанрі (з кількістю голосів > 10000):")
    ...
    print("Найраніший фільм у кожному жанрі з іменами режисерів:")
